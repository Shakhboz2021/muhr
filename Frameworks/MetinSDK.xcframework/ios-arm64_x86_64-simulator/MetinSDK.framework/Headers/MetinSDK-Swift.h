...
#ifndef METINSDK_SWIFT_H
#define METINSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MetinSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("Certificates")
@interface Certificates : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@class NSString;
@interface Certificates (SWIFT_EXTENSION(MetinSDK))
...
SWIFT_CLASS("_TtC8MetinSDK12MetinManager")
@interface MetinManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS_NAMED("PrivatePublicKeys")
@interface PrivatePublicKeys : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@class NSData;
@class NSNumber;
@interface PrivatePublicKeys (SWIFT_EXTENSION(MetinSDK))
@property (nonatomic, copy) NSString * _Nullable dboUserId;
@property (nonatomic, copy) NSData * _Nullable encrypedPrivateKeyData;
@property (nonatomic, copy) NSString * _Nullable innOrPinfl;
@property (nonatomic, copy) NSString * _Nullable pinfl;
@property (nonatomic, copy) NSData * _Nullable publicKey;
@property (nonatomic, copy) NSString * _Nullable serialNumber;
@property (nonatomic, strong) NSNumber * _Nullable triesPin;
@end
